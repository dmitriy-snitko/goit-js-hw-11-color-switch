...
var bodyColorSwitcher = function bodyColorSwitcher() {
  var randomColor = randomIntegerFromInterval(0, _colors.default.length - 1);
  refs.body.style.backgroundColor = _colors.default[randomColor];
};

var toggleDisabledAttribute = function toggleDisabledAttribute() {
