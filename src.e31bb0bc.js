...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../colors.json":[function(require,module,exports) {
...
var buttons = [refs.startBtn, refs.stopBtn, refs.resetBtn];
var timerId = null;
...
var onReset = function onReset() {
  return refs.body.style.backgroundColor = 'white';
};

var bodyColorSwitch = function bodyColorSwitch() {
  var randomIndex = randomIntegerFromInterval(0, _colors.default.length - 1);
  refs.body.style.backgroundColor = _colors.default[randomIndex];
};

var toggleDisabledAttribute = function toggleDisabledAttribute(buttons) {
  buttons.forEach(function (btn) {
    return btn.toggleAttribute('disabled');
  });
};
...
},{"./sass/main.scss":"sass/main.scss","../colors.json":"../colors.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
